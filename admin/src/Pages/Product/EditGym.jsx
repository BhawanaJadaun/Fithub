...
const EditGym = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!token || token === "null" || token === "undefined") {
      ...
      navigate("/register"); // Change if your login route is different
      return;
    }
    for (let key in gym) {
      if (key === "facilities") {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 ml-0 lg:ml-64 transition-all duration-300 glow-border">
    <div className="bg-second shadow-lg rounded-lg p-6">
      <h2 className="text-3xl font-bold mb-6 text-center text-six">
        Edit Gym
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="bg-first text-six py-2 px-4 rounded hover:bg-fifth hover:text-first"
        >
          Update Gym
        </button>
      </form>
